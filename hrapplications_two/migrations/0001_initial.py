    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='hrapplications_two.Application')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responses', to='hrapplications_two.Application')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hrapplications_two.ApplicationQuestion')),
            ],
        ),
        migrations.CreateModel(
            name='HRApplication',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hrapplications_two.HRApplication')),
        ...
        migrations.AddField(
            ...
            name='questions',
            field=models.ManyToManyField(to='hrapplications_two.ApplicationQuestion'),
        ),
        migrations.AddField(
            model_name='application',
            name='form',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='hrapplications_two.ApplicationForm'),
        ),
        migrations.AddField(
            model_name='application',
            name='reviewer',
